                ...
                <div className="container spec__container">
                    <div className="row spec__row">
                        <div className="col text spec__text">
                            <span>Ревматология</span> - область медицины, в компетенцию которой входит диагностика,
                    ...
                    <div className="container">
                        <div className="row spec__row">
                            <div className="col text spec__text">
                                ...
                                <div className="subtitle spec__subtitle-list">
                        ...
                        <div className="row">
                            <div className="col">
                                <p className=" text spec__text spec__info">
